  ...
  const menuItems = <>
      
      {
         ...
         <li> <Link onClick={()=>{document.title='Add a service'}}   className=' font-semibold m-1' to='/add-a-service'>Add A Service</Link></li>
          ...
          :
          <>
          <li onClick={()=>{document.title='LogIn'}}  className='font-semibold'><Link to='/login' className=" bg-rose-900" >Login</Link></li>
          <li onClick={()=>{document.title='SignUp'}}  className='font-semibold'><Link to='/signup' className=" bg-rose-900" >Sign Up</Link></li>
          </>
      }
  </>
...
<div className="navbar bg-rose-900 p-5 text-white font-bold">
  <div className="navbar-start ">
    <div className="dropdown">
      ...
      <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-rose-900 rounded-box  w-52 ">
        ...
        <li> <Link to='/blogs' onClick={()=>{document.title='Services'}} >Services</Link></li>
        {menuItems}
  ...
  <div className="navbar-center hidden lg:flex">
    <ul className="menu menu-horizontal p-0">
      <li> <Link to='/blogs' onClick={()=>{document.title='Blog'}} >Blog</Link></li>
      <li> <Link to='/services' onClick={()=>{document.title='Services'}}  >Services</Link></li>
      {menuItems}
